...
public:
    ...
    */
    ...
    // ADD BY JIN YUSHANG
    bool key_code_press(uint8_t key, uint8_t modifier = 0);
    
    bool key_code_release();
    // JIN ADD END
    ...
    */
    ...
    // ADD BY JIN YUSHANG
    bool media_control_press(MEDIA_KEY key);
    bool media_control_release();
    // JIN ADD END
...
private:
    ...
    // ADD BY JIN YUSHANG
    HID_REPORT KeycodeReleaseReport;
    HID_REPORT MediaControlReleaseReport;
    // JIN ADD END
};
}
