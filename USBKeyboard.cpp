    ...
    USBHID(get_usb_phy(), 0, 0, vendor_id, product_id, product_release)
{
    ...
    // ADD BY JIN YUSHANG
    KeycodeReleaseReport.data[0] = REPORT_ID_KEYBOARD;
    KeycodeReleaseReport.data[1] = 0;
    KeycodeReleaseReport.data[2] = 0;
    KeycodeReleaseReport.data[3] = 0;
    KeycodeReleaseReport.data[4] = 0;
    KeycodeReleaseReport.data[5] = 0;
    KeycodeReleaseReport.data[6] = 0;
    KeycodeReleaseReport.data[7] = 0;
    KeycodeReleaseReport.data[8] = 0;
    KeycodeReleaseReport.length = 9;

    MediaControlReleaseReport.data[0] = REPORT_ID_VOLUME;
    MediaControlReleaseReport.data[1] = 0;
    MediaControlReleaseReport.length = 2;
    // JIN ADD END
}
    ...
    USBHID(phy, 0, 0, vendor_id, product_id, product_release)
{
    ...
    // ADD BY JIN YUSHANG
    #warning PLEASE USE CONSTRUCTOR WITH DEFAULT PARAMETERS! 
    KeycodeReleaseReport.data[0] = REPORT_ID_KEYBOARD;
    KeycodeReleaseReport.data[1] = 0;
    KeycodeReleaseReport.data[2] = 0;
    KeycodeReleaseReport.data[3] = 0;
...
// ADD BY JIN YUSHANG
bool USBKeyboard::key_code_press(uint8_t key, uint8_t modifier)
{
    _mutex.lock();
...
bool USBKeyboard::key_code_release()
{
    _mutex.lock();
    if (!send(&KeycodeReleaseReport))
    {
        _mutex.unlock();
        return false;
    }
...
// ADD BY JIN YUSHANG
bool USBKeyboard::media_control_press(MEDIA_KEY key)
{
    _mutex.lock();
...
bool USBKeyboard::media_control_release()
{
    _mutex.lock();
    if (!send(&MediaControlReleaseReport))
    {
        _mutex.unlock();
        return false;
    }
